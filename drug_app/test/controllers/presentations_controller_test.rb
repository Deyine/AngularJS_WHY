...
class PresentationsControllerTest < ActionController::TestCase
  ...
  test "should create presentation" do
    assert_difference('Presentation.count') do
      post :create, presentation: { presentation_date: @presentation.presentation_date, slide_link: @presentation.slide_link, speaker: @presentation.speaker, title: @presentation.title, youtube_link: @presentation.youtube_link }
    end
  ...
  test "should update presentation" do
    patch :update, id: @presentation, presentation: { presentation_date: @presentation.presentation_date, slide_link: @presentation.slide_link, speaker: @presentation.speaker, title: @presentation.title, youtube_link: @presentation.youtube_link }
    assert_redirected_to presentation_path(assigns(:presentation))
  end
